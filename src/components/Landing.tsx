    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-gradient-to-b from-therapeutic-lightBlue/30 to-white py-20 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto mb-12">
          <div className="bg-white p-6 rounded-lg shadow-md border border-therapeutic-lightBlue/50">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          {user ? (
            <Link to="/chat">
              <Button size="lg" className="bg-therapeutic-blue hover:bg-therapeutic-blue/80">
                Continue to Chat
              </Button>
            </Link>
          ) : (
            <>
              ...
              <Link to="/auth">
                <Button variant="outline" size="lg" className="border-therapeutic-blue text-therapeutic-blue hover:bg-therapeutic-blue/10">
                  Sign In
                </Button>
              </Link>
            </>
